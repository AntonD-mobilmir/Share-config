...
4.  To install from a Web download, you will download either a 
     ZIP file or an EXE file from the Web.

a. If it is an EXE file, follow the automated installation
   steps below for using the EXE file you downloaded.

b. If it is a ZIP file, there are two methods to install
   the Intel(R) Graphics Media Accelerator Driver:  Follow the 
   automated installation steps below for using the SETUP.EXE 
   (included in the downloaded ZIP file) or follow the Manual 
   Have-Disk installation instructions for Windows* XP or 
   Windows* 2000.  Follow the Manual Have-Disk installation 
   instructions to install the Intel(R) HD Audio HDMI Function 
   Driver.


AUTOMATED INSTALL USING DOWNLOADED EXE FILE
-------------------------------------------
...
3. To install the Intel(R) Express Chipset drivers, 
...
AUTOMATED INSTALL USING SETUP.EXE (FROM DOWNLOADED ZIP FILE)
------------------------------------------------------------
...
3. To install the Intel(R) Graphics Media Accelerator drivers, 
      you will download ZIP file and unzip it using a 
       utility such as WinZip* or PKZip*. 
...
On Microsoft Windows* 2000, Manual "Have-Disk" Install 
Instructions for Intel(R) Graphics Media Accelerator Driver
...
9.  Enter the directory where you unzipped the file you 
    ...
    Highlight the "igxp32.INF" file. Click on the "Open" button. 
...
12. Click on the "Close" button.  If a dialog asking to reboot 
    is displayed, click on the "Yes" button to automatically     reboot.  Otherwise, manually restart the system.
...
Microsoft Windows* XP Manual "Have-Disk" Install 
Instructions for Intel(R) Graphics Media Accelerator Driver
(using downloaded ZIP file)
-----------------------------------------------------------
...
12. Click on the "Close" button.  If a dialog asking to reboot 
    is displayed, click on the "Yes" button to automatically 
    reboot.  Otherwise, manually restart the system.
    The driver should now be loaded.
...
2.  For Graphics:
    ...
    Audio Function Driver should  be listed and not yellow banged. 
     If not, the driver is  not installed correctly. To check the 
    version of the driver, refer to the section below.
...
Copyright (c) Intel Corporation, 1998-2007
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<!-- BEGIN JAVASCRIPT FOOTER BLOCK  -->

<!-- END JAVASCRIPT FOOTER BLOCK  -->

<!-- BEGIN JAVASCRIPT SUB-FOOTER BLOCK  -->

<!-- END JAVASCRIPT SUB-FOOTER BLOCK  -->
