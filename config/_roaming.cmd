...
:restart
rem IF NOT EXIST D:\ ECHO Driveletter D: [Data] not accessible & PAUSE & GOTO :restart
...
CALL "%~dp0_Scripts\copy_defaultconfig_to_localhost.cmd" "%~dp0Apps_roaming.7z"
...
IF "%runNotebookScript%"=="1" (
    CALL "%~dp0+notebook.cmd"
) ELSE (
