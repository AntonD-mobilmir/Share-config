...
START "Software Update Scripts Installer" /I %comspec% /C ""\\Srv0.office0.mobilmir\profiles$\Share\software_update\_install\install_software_update_scripts.cmd" /InstallAndMark"
EXIT /B
)
