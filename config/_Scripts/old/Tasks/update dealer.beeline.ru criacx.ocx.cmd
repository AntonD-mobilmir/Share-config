...
SET "TaskRelPath=Tasks\mobilmir.ru\update dealer.beeline.ru criacx.ocx"
...
CALL "%~dp0_Schedule WinVista+ Task.cmd" "%~dp0Tasks.XML.7z" "*" "update dealer.beeline.ru criacx.ocx.xml" /NP /RU "%USERNAME%"
