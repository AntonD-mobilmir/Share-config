...
FileEncoding cp1
Loop Read, %defaultsSourceDir%\_Scripts\AddUsers\Add_Admins_list.txt
{
    If (SubStr(A_LoopReadLine,1,1)==";")
	continue
    nameUserFound := RegexMatch(A_LoopReadLine, "[^/\t]+", adminUserName)
    If (nameUserFound && A_UserName=adminUserName)
	SelfRemoveAndExit()
}
