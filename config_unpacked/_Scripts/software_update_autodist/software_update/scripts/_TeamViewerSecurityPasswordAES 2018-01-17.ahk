...
ListNewPasswds := { "Apps_dept":	"FEBA221281CE27722EEF24C9DA21C6D77D3EF17B677E09215EA089D0068D557174435BC5ECD988A42DF105F02C3CF60B"
		  , "Apps_office":	"41BC52A5628910F7E7AFC950667EDEB0E30CC76CD0CEA3DEF7B0AC3F854A994CEB09E923623C9801EBC1951C7A9D29BA"
		  , "Apps_roaming":	"AE4E99AF00969EA30A47F257F5975140FDD594628E70350C127EA82DBF4629A08CEB08B29D65CE366A396897BFCDBA7B"
		  , "ServiceNote":	"FB32250F6C97A1D01912AFE14F975742CF77E13E0317C9C3309A73F58667257CE6C13C97E40B869F751261D1899B45EB" }

ListOldPasswds := { "FEBA221281CE27722EEF24C9DA21C6D77D3EF17B677E09215EA089D0068D557174435BC5ECD988A42DF105F02C3CF60B": ""	; 2018-01-17 №349 Apps_dept
		  , "41BC52A5628910F7E7AFC950667EDEB0E30CC76CD0CEA3DEF7B0AC3F854A994CEB09E923623C9801EBC1951C7A9D29BA": ""	; 2018-01-17 №350 Apps_office
		  , "AE4E99AF00969EA30A47F257F5975140FDD594628E70350C127EA82DBF4629A08CEB08B29D65CE366A396897BFCDBA7B": ""	; 2018-01-17 №351 Apps_roaming
		  , "FB32250F6C97A1D01912AFE14F975742CF77E13E0317C9C3309A73F58667257CE6C13C97E40B869F751261D1899B45EB": ""	; 2018-01-17 №354 ServiceNote
		  , "3133416EA87A07C4132FDEA27662C33A9152212F70E116E750ED24302A0325BEFB4B0BEE43FB59E5F27AB7141EE51AB4": "!"	; 2018-01-17 №352 TeamViewer_host.defaults.reg
		  , "7955842104E011D7A62AF2726DE0E346749A9F1176753B06ADA80301867DB86F2B5FD91B66197C8A9A86CC1960638033": "!"	; 2018-01-17 №353 TeamViewer5HostUnattended_egs
		  
		  , "1521F2964BD7826E3086A012B83097C43C95A95FD3DE005386308EE60BC77D0F043376055DCD5A8E416053C8C217EF51": "Apps_dept"	; 2017-09-13 Apps_dept
		  , "011A63AD1B98919BE210595C1F03F26EE937A9454C292874787572E84E64781D56E6B0144885AE5B4C50B21384CFA55E": "Apps_office"	; 2017-09-13 Apps_office
		  , "92C58FB6571F0912C6C0318C916E2E01970D0E220A01A64B2CEF00C845C524A1E96893CE6E5CAE4589D791E9C7D71E05": "Apps_roaming"	; 2017-09-13 Apps_roaming
		  , "7F6F9B14ACA7111E8EDC315457999E2E7A0CDDC0CDB5856DADB6D2139652E47EDE55829E38D26E0BEC6A0121AD8C308B": "ServiceNote"	; 2017-09-13 TeamViewer_ServiceNote.reg
		  ...
		  , "F574177FCCEC51367FBDE604C9D7D8BAC00F32131DC7EFC8D33885495010A90526BF392D7177FB520E2B2BB2303A0616": "."	; 2016-08-24 Apps_dept
...
If (write) {
    If (switchKey=="") {
	For name, pass in ListNewPasswds
	    If (pass == curpwd) {
		currPassName := "(" name ") "
		break
	    }
	ShowMsg(einf := "Для текущего пароля " currPassName "ничего делать не требуется.", 0x40)
	write := 0
    } Else If (switchKey==".") {
	...
	ShowMsg("Найденная по паролю конфигурация: " switchKey)
...
WriteRegSettings(ByRef defaultsPath, ByRef einf) {
    global ListNewPasswds
    If (defaultsPath == "")
	Try defaultsPath := getDefaultConfig()
